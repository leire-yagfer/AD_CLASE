...
public class App {
    ...
    public static void main(String[] args) {
        ...
        Usuario usuario1 = new Usuario(202, "A", "A", Date.valueOf(LocalDate.parse("1-1-2000")));
        Usuario usuario2 = new Usuario(203, "B", "B", Date.valueOf(LocalDate.parse("2-2-2000")));
        Usuario usuario3 = new Usuario(204, "C", "C", Date.valueOf(LocalDate.parse("3-3-2000")));
